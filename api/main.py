...
from app.api.routers.admin_categories import (
    router as admin_categories_router,
)
from app.api.routers.admin_category_fields import (
    router as admin_category_fields_router,
)
...
app.include_router(admin_category_fields_router)
